...
{
  /// <summary>
  /// Helpers for SendGrid related conversion methods.
  /// </summary>
  public static class SendGridExtensions
  {
    /// <summary>
    /// Converts a .NET MailMessage to a SendGridMessage.
    /// </summary>
    ...
    public static SendGridMessage GetSendGridMessage(this MailMessage message)
    {
      ...
      {
        sendGridMessage.Attachments = new System.Collections.Generic.List<global::SendGrid.Helpers.Mail.Attachment>();
    ...
    /// <summary>
    /// Converts a .NET MailAddress to a SendGrid EmailAddress.
    /// </summary>
    ...
    /// <summary>
    /// Converts a .NET Attachment to a SendGrid AAttachment.
    /// </summary>
    /// <param name="attachment">The attachment to convert.</param>
    public static global::SendGrid.Helpers.Mail.Attachment GetSendGridAttachment(this System.Net.Mail.Attachment attachment)
    {
      using (var stream = new MemoryStream())
      {
        attachment.ContentStream.CopyTo(stream);
        return new global::SendGrid.Helpers.Mail.Attachment()
        {
